...
<?php echo $this->Form->create('MItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit M Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MItem.item_code')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MItem.item_code'))); ?></li>
