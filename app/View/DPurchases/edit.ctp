...
<?php echo $this->Form->create('DPurchase'); ?>
	<fieldset>
		<legend><?php echo __('Edit D Purchase'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DPurchase.order_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DPurchase.order_id'))); ?></li>
